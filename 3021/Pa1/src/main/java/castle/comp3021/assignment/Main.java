...
public class Main {
    ...
    public static Game createGame(int size, int numMovesProtection) {
        ...
        {
            configuration.addInitialPiece(i % 2 == 0 ? new Knight(userPlayer) : new Archer(userPlayer), i, 0);
            configuration.addInitialPiece(i % 2 == 0 ? new Knight(computerPlayer): new Archer(computerPlayer), i, size - 1);
        }
