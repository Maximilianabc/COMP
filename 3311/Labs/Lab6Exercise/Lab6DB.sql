...
insert into Student values ('13455789','Harry','Potter','cspotter','23581234',null,'COMP','2019');
insert into Student values ('15456789','Leonardo','Da Vinci','csdavinci','23585678',null,'COMP','2019');
insert into Student values ('13556789','Legolas','Greenleaf','magreenleaf','23582468',null,'MATH','2020');
insert into Student values ('13456789','Ariana','Grande','csgrande','23581234',null,'COMP','2020');
insert into Student values ('15678989','Maria','Callas','cscallas','23589876',null,'COMP','2020');
insert into Student values ('15678901','Albert','Einstein','cseinstein','23585678',null,'COMP','2019');
insert into Student values ('16789012','Robert','Redford','maredford','23582468',null,'MATH','2020');
insert into Student values ('14567890','Julius','Caesar','eecaesar','23589876',null,'ELEC','2020');
insert into Student values ('99987654','Lazzy','Lazy','cslazy','23581357',null,'COMP','2020');
insert into Student values ('26184624','Bruce','Wayne','eewayne','28261057',null,'ELEC','2019');
insert into Student values ('26184444','Donald','Trump','bstrump','28255057',null,'BUS','2020');
insert into Student values ('26186666','Warren','Buffet','bsbuffet','28266027',null,'BUS','2019');
insert into Student values ('66666666','Ferris','Bueller','bsbueller','28282727',null,'BUS','2019');
insert into Student values ('15000655','Steve','Jobs','csjobs','26232244',null,'COMP','2019');
insert into Student values ('15085942','Bill','Gates','csgates','25678679',null,'COMP','2020');
insert into Student values ('28834512','Isaac','Newton','manewton','22861987',null,'MATH','2019');
insert into Student values ('28918856','Alan','Turing','maturing','26679834',null,'MATH','2019');
insert into Student values ('29873381','Nikola','Tesla','eetesla','25671983',null,'ELEC','2019');
insert into Student values ('13782973','Edith','Clarke','eeclarke','28340180',null,'ELEC','2019');
insert into Student values ('18792018','Elon','Musk','bsmusk','28659910',null,'BUS','2020');
