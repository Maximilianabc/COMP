...
namespace UniversityWebsite
{
    public partial class SiteMaster : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            liManageDropDown.Visible = false;
            liCreateStudentRecord.Visible = false;
            liModifyStudentRecord.Visible = false;
            liFindDropDown.Visible = false;
            liFindStudentRecord.Visible = false;
            liFindDepartmentStudentRecords.Visible = false;
            // Hide student menu items.
            liEnrollInCourses.Visible = false;
            liFindEnrolledCourses.Visible = false;
            ...
            }
            {
                switch (role)
                {
                    case UniversityRole.Admin:
                        ...
                        liManageDropDown.Visible = true;
                        liCreateStudentRecord.Visible = true;
                        liModifyStudentRecord.Visible = true;
                        liFindDropDown.Visible = true;
                        liFindStudentRecord.Visible = true;
                        liFindDepartmentStudentRecords.Visible = true;
                        break;
                    case UniversityRole.Student:
                        // Show student menu items.
                        liEnrollInCourses.Visible = true;
                        liFindEnrolledCourses.Visible = true;
                        break;
