<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateStudentRecord.aspx.cs" Inherits="UniversityWebsite.Admin.CreateStudentRecord" %>
    ...
    <div class="form-horizontal">
        ...
        <asp:Panel ID="pnlStudentRecord" runat="server" Visible="false">
            <div class="form-group">
                ...
                <div class="col-xs-3">
                    <asp:TextBox runat="server" ID="txtStudentId" CssClass="form-control input-sm" MaxLength="8" ToolTip="Student id" Font-Names="Arial" Width="100px" />
